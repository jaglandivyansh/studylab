...
function makeModernHero() {
    ...
    var glow1 = el("div", {
        css: {
            position: "absolute", top: "-50px", left: "-50px", width: "200px",
            height: "200px", background: "radial-gradient(circle, var(--accent) 0%, transparent 70%)",
...
function createSmartFeedbackWidget() {
    var widgetWrap = el("div", {
        css: {
            ...
            borderRadius: "20px", padding: "24px 20px", margin: "32px auto",
            maxWidth: "600px", width: "calc(100% - 32px)", boxSizing: "border-box", // ADDED: Box sizing & max-width fixes overflow
    ...
    var emojiDisplay = el("div", {
        css: { 
            ...
            display: "inline-block", // block ki jagah inline-block ensure center se animate ho
            transformOrigin: "center", // GPU composite layer
        ...
        star.onclick = function() {
            ...
            stars.forEach((s, index) => {
                if (index < currentRating) {
                    ...
                    s.style.textShadow = "0 15px rgba(245, 158, 11, 0.4)";
    ...
    var textArea = el("textarea", {
        css: { 
            ...
            background: "var(--bg2)", color: "var(--text)", minHeight: "90px",
            marginBottom: "16px", fontFamily: "inherit", resize: "none", 
            boxSizing: "border-box", display: "block", maxWidth: "100%", fontSize: ".9rem" // ADDED: box-sizing, display, and max-width prevents overflowing
        }
    });
    ...
    var submitBtn = el("button", {
        css: { 
            ...
            boxSizing: "border-box", display: "block" // ADDED: Prevents scaling layout issues
        },
        txt: "Send Feedback"
    });
...
// MAIN PAGE RENDER
function pgHome(){
    var tot = SUBJ.reduce(function(s,k){ return s + (typeof QD !== 'undefined' && QD[k] ? QD[k].length : 0); },0);
    var w = el("div", {cls:"fd"});
    ...
    var SD = {
        History: {color:"#7c3aed",bg:"#f5f3ff",desc:"Explore ancient civilizations, medieval kingdoms, freedom struggle, and modern India.", topics:["Indus Valley", "Mughal Empire", "British Raj", "Independence Movement", "Ancient India"], sym:["🏛️","⚔️","👑","🛡️","📜"]},
        Geography: {color:"#059669",bg:"#ecfdf5",desc:"From Himalayas to coastal plains, rivers, climate zones, and world physical features.", topics:["Rivers & Lakes", "Climate", "Physical Features", "World Map", "Agriculture"], sym:["⛰️","🌍","🌊","🌧️","🌱"]},
        Polity: {color:"#dc2626",bg:"#fef2f2",desc:"Indian Constitution, Parliament, judiciary, fundamental rights and governance structure.", topics:["Constitution", "Parliament", "Fundamental Rights", "Judiciary", "Local Governance"], sym:["⚖️","🏛️","📜","🛡️","🤝"]},
        ...
        Science: {color:"#0891b2",bg:"#ecfeff",desc:"Physics, chemistry, biology, technology, space, inventions and scientific discoveries.", topics:["Physics", "Chemistry", "Biology", "Space Tech", "Inventions"], sym:["🔬","🧬","🔭","🧪","🚀"]},
        ...
        "Previous Year Questions": {color:"#8b5cf6",bg:"#f5f3ff",desc:"Practice with actual past exam papers to understand patterns and difficulty levels.", topics: ["UPSC","SSC CGL","Railways", "Banking", "State PCS"], sym:["📜","⏳","📝","📚","🎓"]}
    };
    ...
    if (typeof SUBJ !== 'undefined') {
        SUBJ.forEach(function(s,idx){
            ...
            var row = el("div",{
                css: {display:"flex", alignItems:"stretch", gap:"0", marginBottom:"20px", borderRadius:"20px", overflow:"hidden", boxShadow:"0 8px 32px rgba(0,0,0,.25)", cursor:"pointer", minHeight:"180px"}, 
            ...
            (d.topics||[]).forEach(function(t){
                chips.appendChild(el("span", {
                    css: {fontSize:".68rem", fontWeight:"600", padding:"3px 10px", borderRadius:"6px", background:d.color+"18",color:d.color, border:"1px solid "+d.color+"28", fontFamily:"var(--font-display)", letterSpacing: "0.02em"}
                }, t));
            });
